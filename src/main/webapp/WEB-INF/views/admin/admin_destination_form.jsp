						...
						<div class="row">
							<div class="col-md-12">
								<div class="overview-wrap">
									<h2 class="title-1 m-b-25">Modifier&nbsp;une&nbsp;destination</h2>
								</div>
								<div class="col-md-12">
									<div class="card">
										<div class="card-header">Modifier&nbsp;une&nbsp;destination</div>
										<f:form action="saveDestination" method="get"
											...
											<div class="card-footer">
												...
												<button class="btn btn-warning btn-sm"
													formaction="saveDestination">
													<i class="fa fa-map-marker"></i>&nbsp;Modifier
												</button>
											</div>
										</f:form>
									</div>
